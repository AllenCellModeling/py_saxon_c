...
[![Build Status](https://github.com/AllenCellModeling/py_saxon_c/workflows/Build%20Master/badge.svg)](https://github.com/AllenCellModeling/py_saxon_c/actions)
[![Documentation](https://github.com/AllenCellModeling/py_saxon_c/workflows/Documentation/badge.svg)](https://AllenCellModeling.github.io/py_saxon_c)
[![Code Coverage](https://codecov.io/gh/AllenCellModeling/py_saxon_c/branch/master/graph/badge.svg)](https://codecov.io/gh/AllenCellModeling/py_saxon_c)

Friendly version of saxons python library that will be pip installable 
...
## Quick Start
```python
from py_saxon_c import Example
...
## Installation
**Stable Release:** `pip install py_saxon_c`<br>
**Development Head:** `pip install git+https://github.com/AllenCellModeling/py_saxon_c.git`

## Documentation
For full package documentation please visit [AllenCellModeling.github.io/py_saxon_c](https://AllenCellModeling.github.io/py_saxon_c).
...
* Turn your project into a GitHub repository:
  ...
  * After `git` has initialized locally, run the following commands:
    * `git remote add origin git@github.com:AllenCellModeling/py_saxon_c.git`
    * `git push -u origin master`
* Register py_saxon_c with Codecov:
  * Make an account on [codecov.io](https://codecov.io) (Recommended to sign in with GitHub)
  * Select `AllenCellModeling` and click: `Add new repository`
  * Copy the token provided, go to your [GitHub repository's settings and under the `Secrets` tab](https://github.com/AllenCellModeling/py_saxon_c/settings/secrets),
...
* Generate and add an access token as a secret to the repository for auto documentation generation to work
  ...
  * Go to your [GitHub repository's settings and under the `Secrets` tab](https://github.com/AllenCellModeling/py_saxon_c/settings/secrets),
...
* Add branch protections to `master` and `stable`
    * To protect from just anyone pushing to `master` or `stable` (the branches with more tests and deploy
    configurations)
    * Go to your [GitHub repository's settings and under the `Branches` tab](https://github.com/AllenCellModeling/py_saxon_c/settings/branches), click `Add rule` and select the
